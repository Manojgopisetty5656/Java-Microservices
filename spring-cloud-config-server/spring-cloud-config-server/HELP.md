...
* The original package name 'com.manoj.microservices.spring-cloud-config-server' is invalid and this project uses 'com.manoj.microservices.springcloudconfigserver' instead.
